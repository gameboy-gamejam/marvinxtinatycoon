...
public class FishStage extends Stage {
	...
	protected void playGame() {
		...
		mFishingRod.setCatchBarPosX(mSeeder.nextInt((int) mFishingRod
				.getMovableDistanceWidth()));
		mFishingRod.setIsLakeWithFish(mSeeder.nextBoolean());
		mFishingRod.setRarityOfFish(mSeeder
				.nextInt(FishingRodBar.RARITY_OF_FISH_MAX_PT));
	...
	protected void endGame() {// pede kaya dito yung up?
		if (mSelectedPondIdx > -1) {
			mIsGameFinish = true;
			mIsScriptRunning = false;// TODO mag-isip ng cases na dapat nag-end
										// yung game
	...
	protected void showReadyInstruction() {
		...
		intent.putExtra(GBGameTipPopUp.KEY_EXTRA_TIP,
				res.getString(R.string.tip_fishing));

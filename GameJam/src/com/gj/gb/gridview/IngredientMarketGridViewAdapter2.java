...
public class IngredientMarketGridViewAdapter2 extends ArrayAdapter<Integer> {
	...
	public IngredientMarketGridViewAdapter2(Context context, List<Integer> objects) {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		GBIngredient ingredient = GBIngredientsFactory.getIngredientById(getItem(position));
